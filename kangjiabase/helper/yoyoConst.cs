...
namespace kangjiabase
{
    public static class yoyoConst
    {
        ...
        private static void initFlash()
        {
            ...
            flashmodel = new flashmodel();
            flashmodel.step = YoyoStep.no;
            flashmodel.flashname = "sex_select";
            flashmodel.url = "<invoke name=\"sex_select\" returntype=\"xml\"><arguments><true/><false/></arguments></invoke>";
            ...
            flashmodel.flashname = "sex_select";
            flashmodel.url = "<invoke name=\"sex_select\" returntype=\"xml\"><arguments><true/><true/></arguments></invoke>";
            flashmodel.muiscname = "sex_male";
            dict.Add(flashmodel.step, flashmodel);
            ...
            flashmodel.flashname = "sex_select";
            flashmodel.url = "<invoke name=\"sex_select\" returntype=\"xml\"><arguments><false/><true/></arguments></invoke>";
            ...
            flashmodel.url = "<invoke name=\"testing\" returntype=\"xml\"><arguments><number>{0}</number><false/></arguments></invoke>";
            flashmodel.muiscname = "didi";
            dict.Add(flashmodel.step, flashmodel);


            flashmodel = new flashmodel();
            flashmodel.step = YoyoStep.testing1;
            flashmodel.flashname = "testing_male";
            flashmodel.url = "<invoke name=\"testing\" returntype=\"xml\"><arguments><number>{0}</number><true/></arguments></invoke>";
            flashmodel.muiscname = "didi";
            dict.Add(flashmodel.step, flashmodel);
            ...
            flashmodel.url = "<invoke name=\"result\" returntype=\"xml\"><arguments><string>{0}</string><false/></arguments></invoke>";
            ...
            if ((PRINT == "1")|| (PRINT == "2"))
            {
                ...
                flashmodel.flashname = "result";
                flashmodel.url = "<invoke name=\"result\" returntype=\"xml\"><arguments><string>{0}</string><true/></arguments></invoke>";
